    ...
    context '異常系' do
      context 'メールアドレスが引数にない場合' do
        ...
        it 'ArgumentErrorがスローされること' do
          expect { Login::LoginDomain.create(logins) }.to raise_error(ArgumentError, 'emailがありません')
        end
      end
      ...
      context 'パスワードが引数にない場合' do
        ...
        it 'ArgumentErrorがスローされること' do
          expect { Login::LoginDomain.create(logins) }.to raise_error(ArgumentError, 'passwordがありません')
        end
      end
      ...
      context 'emailのフォーマットが不正な場合' do
        ...
        it 'EmailFormatErrorがスローされること' do
          expect { Login::LoginDomain.create(logins) }.to raise_error(Login::LoginError::EmailFormatError)
        end
      end
      ...
      context 'passwordのフォーマットが不正な場合' do
        ...
        it 'PasswordFormatErrorがスローされること' do
          expect { Login::LoginDomain.create(logins) }.to raise_error(Login::LoginError::PasswordFormatError)
        end
      end
    end
  end
